...
const mod_config = {
    module : 'folkgame',
    resource : 'folkgame_bet',
    collection : 'folkgame_bets',
    route : 'folkgame/folkgame_bet',
    view : 'folkgame_bet',
    alias : 'folkgame_bet'
};

const folkgame_bet = express.Router();
folkgame_bet.get('/', async function(req, res) {
...
//Get add
folkgame_bet.get('/add', async function(req, res){
    try {
        const dataView = helpers.admin.get_data_view_admin(req,mod_config);
...
//Post add
folkgame_bet.post('/add', async function(req, res){
    try {
...
//Get edit
folkgame_bet.get('/edit/:id', async function (req, res) {
    try {
        //validate
...
//post edit
folkgame_bet.post('/edit/:id', async function (req, res) {
    try {
        let postData = {...req.body};
...
//GET import
folkgame_bet.get('/import', function(req, res){
    try {
 ...
 *
 */
folkgame_bet.post('/import', async function(req, res){
    try {
...
//GET export
folkgame_bet.get('/export', async function(req, res){
    try {
        let dataView = helpers.admin.get_data_view_admin(req, mod_config);
        let fields = await moduleModel.get_fields(mod_config,'__v',dataView.role);
        let field_keys = Object.keys(fields);
...
//Export
folkgame_bet.post('/export', async function(req, res){
    try {
...
//delete
folkgame_bet.post('/delete', async function (req, res) {
...
//Get detail
folkgame_bet.get('/detail/:_id', async function(req, res){
    try {
        //validate
        const validator = new helpers.validate();
...
folkgame_bet.get("/report", async function (req, res) {
	try {
		const dataView = helpers.admin.get_data_view_admin(req, mod_config);
		let ignore_fields = "__v update_by createdAt updatedAt";
		dataView.fields = await moduleModel.get_fields(mod_config, ignore_fields);
...
// report
folkgame_bet.post("/report", async function (req, res) {
	try {
