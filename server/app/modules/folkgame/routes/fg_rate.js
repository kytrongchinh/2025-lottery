...
const mod_config = {
    module : 'folkgame',
    resource : 'fg_rate',
    collection : 'folkgame_rates',
    route : 'folkgame/fg_rate',
    view : 'fg_rate',
    alias : 'fg_rate'
};

const fg_rate = express.Router();
fg_rate.get('/', async function(req, res) {
...
//Get add
fg_rate.get('/add', async function(req, res){
    try {
        const dataView = helpers.admin.get_data_view_admin(req,mod_config);
...
//Post add
fg_rate.post('/add', async function(req, res){
    try {
...
//Get edit
fg_rate.get('/edit/:id', async function (req, res) {
    try {
        //validate
...
//post edit
fg_rate.post('/edit/:id', async function (req, res) {
    try {
        let postData = {...req.body};
...
//GET import
fg_rate.get('/import', function(req, res){
    try {
 ...
 *
 */
fg_rate.post('/import', async function(req, res){
    try {
...
//GET export
fg_rate.get('/export', async function(req, res){
    try {
        let dataView = helpers.admin.get_data_view_admin(req, mod_config);
        let fields = await moduleModel.get_fields(mod_config,'__v',dataView.role);
        let field_keys = Object.keys(fields);
...
//Export
fg_rate.post('/export', async function(req, res){
    try {
...
//delete
fg_rate.post('/delete', async function (req, res) {
...
//Get detail
fg_rate.get('/detail/:_id', async function(req, res){
    try {
        //validate
        const validator = new helpers.validate();
...
fg_rate.get("/report", async function (req, res) {
	try {
		const dataView = helpers.admin.get_data_view_admin(req, mod_config);
		let ignore_fields = "__v update_by createdAt updatedAt";
		dataView.fields = await moduleModel.get_fields(mod_config, ignore_fields);
...
// report
fg_rate.post("/report", async function (req, res) {
	try {
