...
const mod_config = {
    module : 'lucky',
    resource : 'schedule',
    collection : 'lk_schedules',
    route : 'lucky/schedule',
    view : 'schedule',
    alias : 'schedule'
};
...
//Get add
schedule.get('/add', async function(req, res){
    try {
        const dataView = helpers.admin.get_data_view_admin(req,mod_config);
...
//Post add
schedule.post('/add', async function(req, res){
    try {
...
//Get edit
schedule.get('/edit/:id', async function (req, res) {
    try {
        //validate
...
//post edit
schedule.post('/edit/:id', async function (req, res) {
    try {
        let postData = {...req.body};
...
//GET import
schedule.get('/import', function(req, res){
    try {
 ...
 *
 */
schedule.post('/import', async function(req, res){
    try {
...
//GET export
schedule.get('/export', async function(req, res){
    try {
        let dataView = helpers.admin.get_data_view_admin(req, mod_config);
        let fields = await moduleModel.get_fields(mod_config,'__v',dataView.role);
        let field_keys = Object.keys(fields);
...
//Export
schedule.post('/export', async function(req, res){
    try {
...
//delete
schedule.post('/delete', async function (req, res) {
...
//Get detail
schedule.get('/detail/:_id', async function(req, res){
    try {
        //validate
        const validator = new helpers.validate();
...
schedule.get("/report", async function (req, res) {
	try {
		const dataView = helpers.admin.get_data_view_admin(req, mod_config);
		let ignore_fields = "__v update_by createdAt updatedAt";
		dataView.fields = await moduleModel.get_fields(mod_config, ignore_fields);
...
// report
schedule.post("/report", async function (req, res) {
	try {
