...
const mod_config = {
    module : 'lucky',
    resource : 'user_bet_date',
    collection : 'lk_user_bet_dates',
    route : 'lucky/user_bet_date',
    view : 'user_bet_date',
    alias : 'user_bet_date'
};

const user_bet_date = express.Router();
user_bet_date.get('/', async function(req, res) {
...
//Get add
user_bet_date.get('/add', async function(req, res){
    try {
        const dataView = helpers.admin.get_data_view_admin(req,mod_config);
...
//Post add
user_bet_date.post('/add', async function(req, res){
    try {
...
//Get edit
user_bet_date.get('/edit/:id', async function (req, res) {
    try {
        //validate
...
//post edit
user_bet_date.post('/edit/:id', async function (req, res) {
    try {
        let postData = {...req.body};
...
//GET import
user_bet_date.get('/import', function(req, res){
    try {
 ...
 *
 */
user_bet_date.post('/import', async function(req, res){
    try {
...
//GET export
user_bet_date.get('/export', async function(req, res){
    try {
        let dataView = helpers.admin.get_data_view_admin(req, mod_config);
        let fields = await moduleModel.get_fields(mod_config,'__v',dataView.role);
        let field_keys = Object.keys(fields);
...
//Export
user_bet_date.post('/export', async function(req, res){
    try {
...
//delete
user_bet_date.post('/delete', async function (req, res) {
...
//Get detail
user_bet_date.get('/detail/:_id', async function(req, res){
    try {
        //validate
        const validator = new helpers.validate();
...
user_bet_date.get("/report", async function (req, res) {
	try {
		const dataView = helpers.admin.get_data_view_admin(req, mod_config);
		let ignore_fields = "__v update_by createdAt updatedAt";
		dataView.fields = await moduleModel.get_fields(mod_config, ignore_fields);
...
// report
user_bet_date.post("/report", async function (req, res) {
	try {
