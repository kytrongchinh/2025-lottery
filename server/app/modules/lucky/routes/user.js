...
//Get add
user.get('/add', async function(req, res){
    try {
        const dataView = helpers.admin.get_data_view_admin(req,mod_config);
...
//Get edit
user.get('/edit/:id', async function (req, res) {
    try {
        //validate
...
//post edit
user.post('/edit/:id', async function (req, res) {
    try {
        let postData = {...req.body};
...
//GET import
user.get('/import', function(req, res){
    try {
 ...
 *
 */
user.post('/import', async function(req, res){
    try {
...
//GET export
user.get('/export', async function(req, res){
    try {
        let dataView = helpers.admin.get_data_view_admin(req, mod_config);
        let fields = await moduleModel.get_fields(mod_config,'__v',dataView.role);
        let field_keys = Object.keys(fields);
...
//Export
user.post('/export', async function(req, res){
    try {
...
//Get detail
user.get('/detail/:_id', async function(req, res){
    try {
        //validate
        const validator = new helpers.validate();
...
user.get("/report", async function (req, res) {
	try {
		const dataView = helpers.admin.get_data_view_admin(req, mod_config);
		let ignore_fields = "__v update_by createdAt updatedAt";
		dataView.fields = await moduleModel.get_fields(mod_config, ignore_fields);
...
// report
user.post("/report", async function (req, res) {
	try {
