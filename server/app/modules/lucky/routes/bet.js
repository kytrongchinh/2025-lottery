...
bet.get('/', async function(req, res) {
...
//Get add
bet.get('/add', async function(req, res){
    try {
        const dataView = helpers.admin.get_data_view_admin(req,mod_config);
...
//Post add
bet.post('/add', async function(req, res){
    try {
...
//Get edit
bet.get('/edit/:id', async function (req, res) {
    try {
        //validate
...
//post edit
bet.post('/edit/:id', async function (req, res) {
    try {
        let postData = {...req.body};
...
//GET import
bet.get('/import', function(req, res){
    try {
 ...
 *
 */
bet.post('/import', async function(req, res){
    try {
...
//GET export
bet.get('/export', async function(req, res){
    try {
        let dataView = helpers.admin.get_data_view_admin(req, mod_config);
        let fields = await moduleModel.get_fields(mod_config,'__v',dataView.role);
        let field_keys = Object.keys(fields);
...
//Export
bet.post('/export', async function(req, res){
    try {
...
//delete
bet.post('/delete', async function (req, res) {
...
//Get detail
bet.get('/detail/:_id', async function(req, res){
    try {
        //validate
        const validator = new helpers.validate();
...
bet.get("/report", async function (req, res) {
	try {
		const dataView = helpers.admin.get_data_view_admin(req, mod_config);
		let ignore_fields = "__v update_by createdAt updatedAt";
		dataView.fields = await moduleModel.get_fields(mod_config, ignore_fields);
...
// report
bet.post("/report", async function (req, res) {
	try {
