...
const mod_config = {
    module : 'lucky',
    resource : 'publisher_bet_date',
    collection : 'lk_publisher_bet_dates',
    route : 'lucky/publisher_bet_date',
    view : 'publisher_bet_date',
    alias : 'publisher_bet_date'
};

const publisher_bet_date = express.Router();
publisher_bet_date.get('/', async function(req, res) {
...
//Get add
publisher_bet_date.get('/add', async function(req, res){
    try {
        const dataView = helpers.admin.get_data_view_admin(req,mod_config);
...
//Post add
publisher_bet_date.post('/add', async function(req, res){
    try {
...
//Get edit
publisher_bet_date.get('/edit/:id', async function (req, res) {
    try {
        //validate
...
//post edit
publisher_bet_date.post('/edit/:id', async function (req, res) {
    try {
        let postData = {...req.body};
...
//GET import
publisher_bet_date.get('/import', function(req, res){
    try {
 ...
 *
 */
publisher_bet_date.post('/import', async function(req, res){
    try {
...
//GET export
publisher_bet_date.get('/export', async function(req, res){
    try {
        let dataView = helpers.admin.get_data_view_admin(req, mod_config);
        let fields = await moduleModel.get_fields(mod_config,'__v',dataView.role);
        let field_keys = Object.keys(fields);
...
//Export
publisher_bet_date.post('/export', async function(req, res){
    try {
...
//delete
publisher_bet_date.post('/delete', async function (req, res) {
...
//Get detail
publisher_bet_date.get('/detail/:_id', async function(req, res){
    try {
        //validate
        const validator = new helpers.validate();
...
publisher_bet_date.get("/report", async function (req, res) {
	try {
		const dataView = helpers.admin.get_data_view_admin(req, mod_config);
		let ignore_fields = "__v update_by createdAt updatedAt";
		dataView.fields = await moduleModel.get_fields(mod_config, ignore_fields);
...
// report
publisher_bet_date.post("/report", async function (req, res) {
	try {
...
module.exports = publisher_bet_date;