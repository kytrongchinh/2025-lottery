...
const mod_config = {
	module: "lucky",
	resource: "publisher",
	collection: "lk_publishers",
	route: "lucky/publisher",
	view: "publisher",
	alias: "publisher",
};
...
//Get add
publisher.get("/add", async function (req, res) {
	try {
		const dataView = helpers.admin.get_data_view_admin(req, mod_config);
...
//Post add
publisher.post("/add", async function (req, res) {
	try {
...
//Get edit
publisher.get("/edit/:id", async function (req, res) {
	try {
		//validate
...
//post edit
publisher.post("/edit/:id", async function (req, res) {
	try {
		let postData = { ...req.body };
...
//GET import
publisher.get("/import", function (req, res) {
	try {
 ...
 *
 */
publisher.post("/import", async function (req, res) {
	try {
...
//GET export
publisher.get("/export", async function (req, res) {
	try {
		let dataView = helpers.admin.get_data_view_admin(req, mod_config);
		let fields = await moduleModel.get_fields(mod_config, "__v", dataView.role);
		let field_keys = Object.keys(fields);
...
//Export
publisher.post("/export", async function (req, res) {
	try {
...
//delete
publisher.post("/delete", async function (req, res) {
...
//Get detail
publisher.get("/detail/:_id", async function (req, res) {
	try {
		//validate
		const validator = new helpers.validate();
...
publisher.get("/report", async function (req, res) {
	try {
		const dataView = helpers.admin.get_data_view_admin(req, mod_config);
		let ignore_fields = "__v update_by createdAt updatedAt";
		dataView.fields = await moduleModel.get_fields(mod_config, ignore_fields);
...
// report
publisher.post("/report", async function (req, res) {
	try {
