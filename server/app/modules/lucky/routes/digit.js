...
//Get add
digit.get('/add', async function(req, res){
    try {
        const dataView = helpers.admin.get_data_view_admin(req,mod_config);
...
//Post add
digit.post('/add', async function(req, res){
    try {
...
//Get edit
digit.get('/edit/:id', async function (req, res) {
    try {
        //validate
...
//post edit
digit.post('/edit/:id', async function (req, res) {
    try {
        let postData = {...req.body};
...
//GET import
digit.get('/import', function(req, res){
    try {
 ...
 *
 */
digit.post('/import', async function(req, res){
    try {
...
//GET export
digit.get('/export', async function(req, res){
    try {
        let dataView = helpers.admin.get_data_view_admin(req, mod_config);
        let fields = await moduleModel.get_fields(mod_config,'__v',dataView.role);
        let field_keys = Object.keys(fields);
...
//Export
digit.post('/export', async function(req, res){
    try {
...
//delete
digit.post('/delete', async function (req, res) {
...
//Get detail
digit.get('/detail/:_id', async function(req, res){
    try {
        //validate
        const validator = new helpers.validate();
...
digit.get("/report", async function (req, res) {
	try {
		const dataView = helpers.admin.get_data_view_admin(req, mod_config);
		let ignore_fields = "__v update_by createdAt updatedAt";
		dataView.fields = await moduleModel.get_fields(mod_config, ignore_fields);
...
// report
digit.post("/report", async function (req, res) {
	try {
