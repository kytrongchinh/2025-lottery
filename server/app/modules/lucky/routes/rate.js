...
rate.get('/', async function(req, res) {
...
//Get add
rate.get('/add', async function(req, res){
    try {
        const dataView = helpers.admin.get_data_view_admin(req,mod_config);
...
//Post add
rate.post('/add', async function(req, res){
    try {
...
//Get edit
rate.get('/edit/:id', async function (req, res) {
    try {
        //validate
...
//post edit
rate.post('/edit/:id', async function (req, res) {
    try {
        let postData = {...req.body};
...
//GET import
rate.get('/import', function(req, res){
    try {
 ...
 *
 */
rate.post('/import', async function(req, res){
    try {
...
//GET export
rate.get('/export', async function(req, res){
    try {
        let dataView = helpers.admin.get_data_view_admin(req, mod_config);
        let fields = await moduleModel.get_fields(mod_config,'__v',dataView.role);
        let field_keys = Object.keys(fields);
...
//Export
rate.post('/export', async function(req, res){
    try {
...
//delete
rate.post('/delete', async function (req, res) {
...
//Get detail
rate.get('/detail/:_id', async function(req, res){
    try {
        //validate
        const validator = new helpers.validate();
...
rate.get("/report", async function (req, res) {
	try {
		const dataView = helpers.admin.get_data_view_admin(req, mod_config);
		let ignore_fields = "__v update_by createdAt updatedAt";
		dataView.fields = await moduleModel.get_fields(mod_config, ignore_fields);
...
// report
rate.post("/report", async function (req, res) {
	try {
