...
const mod_config = {
    module : 'lucky',
    resource : 'publisher_bet',
    collection : 'lk_publisher_bets',
    route : 'lucky/publisher_bet',
    view : 'publisher_bet',
    alias : 'publisher_bet'
};

const publisher_bet = express.Router();
publisher_bet.get('/', async function(req, res) {
...
//Get add
publisher_bet.get('/add', async function(req, res){
    try {
        const dataView = helpers.admin.get_data_view_admin(req,mod_config);
...
//Post add
publisher_bet.post('/add', async function(req, res){
    try {
...
//Get edit
publisher_bet.get('/edit/:id', async function (req, res) {
    try {
        //validate
...
//post edit
publisher_bet.post('/edit/:id', async function (req, res) {
    try {
        let postData = {...req.body};
...
//GET import
publisher_bet.get('/import', function(req, res){
    try {
 ...
 *
 */
publisher_bet.post('/import', async function(req, res){
    try {
...
//GET export
publisher_bet.get('/export', async function(req, res){
    try {
        let dataView = helpers.admin.get_data_view_admin(req, mod_config);
        let fields = await moduleModel.get_fields(mod_config,'__v',dataView.role);
        let field_keys = Object.keys(fields);
...
//Export
publisher_bet.post('/export', async function(req, res){
    try {
...
//delete
publisher_bet.post('/delete', async function (req, res) {
...
//Get detail
publisher_bet.get('/detail/:_id', async function(req, res){
    try {
        //validate
        const validator = new helpers.validate();
...
publisher_bet.get("/report", async function (req, res) {
	try {
		const dataView = helpers.admin.get_data_view_admin(req, mod_config);
		let ignore_fields = "__v update_by createdAt updatedAt";
		dataView.fields = await moduleModel.get_fields(mod_config, ignore_fields);
...
// report
publisher_bet.post("/report", async function (req, res) {
	try {
