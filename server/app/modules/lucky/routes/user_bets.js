...
const mod_config = {
    module : 'lucky',
    resource : 'user_bets',
    collection : 'lk_user_bets',
    route : 'lucky/user_bets',
    view : 'user_bets',
    alias : 'user_bets'
};

const user_bets = express.Router();
user_bets.get('/', async function(req, res) {
...
//Get add
user_bets.get('/add', async function(req, res){
    try {
        const dataView = helpers.admin.get_data_view_admin(req,mod_config);
...
//Post add
user_bets.post('/add', async function(req, res){
    try {
...
//Get edit
user_bets.get('/edit/:id', async function (req, res) {
    try {
        //validate
...
//post edit
user_bets.post('/edit/:id', async function (req, res) {
    try {
        let postData = {...req.body};
...
//GET import
user_bets.get('/import', function(req, res){
    try {
 ...
 *
 */
user_bets.post('/import', async function(req, res){
    try {
...
//GET export
user_bets.get('/export', async function(req, res){
    try {
        let dataView = helpers.admin.get_data_view_admin(req, mod_config);
        let fields = await moduleModel.get_fields(mod_config,'__v',dataView.role);
        let field_keys = Object.keys(fields);
...
//Export
user_bets.post('/export', async function(req, res){
    try {
...
//delete
user_bets.post('/delete', async function (req, res) {
...
//Get detail
user_bets.get('/detail/:_id', async function(req, res){
    try {
        //validate
        const validator = new helpers.validate();
...
user_bets.get("/report", async function (req, res) {
	try {
		const dataView = helpers.admin.get_data_view_admin(req, mod_config);
		let ignore_fields = "__v update_by createdAt updatedAt";
		dataView.fields = await moduleModel.get_fields(mod_config, ignore_fields);
...
// report
user_bets.post("/report", async function (req, res) {
	try {
