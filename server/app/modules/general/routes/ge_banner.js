...
const mod_config = {
    module: 'general',
    resource: 'ge_banner',
    collection: 'ge_banners',
    route: 'general/ge_banner',
    view: 'ge_banner',
    alias: 'ge_banner'
};
const upload = require("../../../utils/multer.config");

const ge_banner = express.Router();
ge_banner.get('/', async function (req, res) {
...
//Get add
ge_banner.get('/add', async function (req, res) {
    try {
        const dataView = helpers.admin.get_data_view_admin(req, mod_config);
...
//Post add
ge_banner.post('/add', async function (req, res) {
    try {
...
ge_banner.post('/add-custom', upload.single("image"), async function (req, res) {
    try {
        let postData = { ...req.body }
...
//Get edit
ge_banner.get('/edit/:id', async function (req, res) {
    try {
        //validate
...
//post edit
ge_banner.post('/edit/:id', async function (req, res) {
    try {
...
ge_banner.post('/edit-custom', upload.single("image"), async function (req, res) {
    try {
...
//GET import
ge_banner.get('/import', function (req, res) {
    try {
 ...
 *
 */
ge_banner.post('/import', async function (req, res) {
    try {
...
//GET export
ge_banner.get('/export', async function (req, res) {
    try {
        let dataView = helpers.admin.get_data_view_admin(req, mod_config);
        let fields = await moduleModel.get_fields(mod_config, '__v', dataView.role);
        let field_keys = Object.keys(fields);
...
//Export
ge_banner.post('/export', async function (req, res) {
    try {
...
//delete
ge_banner.post('/delete', async function (req, res) {
...
//Get detail
ge_banner.get('/detail/:_id', async function (req, res) {
    try {
        //validate
        const validator = new helpers.validate();
...
ge_banner.get("/report", async function (req, res) {
    try {
        const dataView = helpers.admin.get_data_view_admin(req, mod_config);
        let ignore_fields = "__v update_by createdAt updatedAt";
        dataView.fields = await moduleModel.get_fields(mod_config, ignore_fields);
...
// report
ge_banner.post("/report", async function (req, res) {
    try {
